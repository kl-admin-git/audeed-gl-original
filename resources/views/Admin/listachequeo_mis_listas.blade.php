...
@section('breadcrumb')
    ...
    @section('section')
                        ...
                        <div class="col-lg-12">
                            <div class="contenedorEncabezado">
                                ...
                                <div class="contenedorBotonesTabs">
                                    ...
                                    <a href="{{ route('List_MyList_Excecuted') }}" class="btn colorTabs"
                                        id="tour-ejecutadas">
                                ...
                                @if (auth()->user()->perfil_id == 1)
                                    ...
                                    <div class="contenedorBotonesCrear">
                                        ...
                                        <button type="button"
                                            class="btn btn-primary waves-effect waves-light crearDesdeCero"
                                            id="tour-nuevo">Nuevo desde cero</button>
                                    </div>
                                @endif
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" required=""
                                                        placeholder="Buscar por titulo lista de chequeo">
                                                </div>
                                            </div>
        ...
        <div class="modal fade bs-example-modal-lg" id="crearMiListaPopUp" tabindex="-1" role="dialog"
                                    ...
                                    <form class="" id="formularioCrearMiLista" action="#">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="form-group">
                                                    <label>Nombre: </label>
                                                    <input type="text" class="form-control nombreMiListaPopUp" required
                                                ...
                                                <div class="form-group">
                                                    <label>Manejar Ponderados:</label>

                                                    <div class="form-check">
                                                        <input class="form-check-input estadoInicialPopUp" type="radio"
                                                            name="manejar_ponderados" id="ponderado_si" value="1"
                                                            >
                                                        <label class="form-check-label" for="ponderado_si">
                                                            Sí
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input estadoInicialPopUp" type="radio"
                                                            name="manejar_ponderados" id="ponderado_no" value="0" checked>
                                                        <label class="form-check-label" for="ponderado_no" >
                                                            No
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="checkBoxAutomatico" checked>
                                                            <label class="custom-control-label font-13 labelCheck"
                                                                for="checkBoxAutomatico">Ponderados automáticos (Desmarcar
                                                                para asignarlos manualmente)</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group m-b-0">
                                            <div class="contenedorBotonesCreacion">
                                                <button type="button"
                                                    class="btn btn-primary waves-effect waves-light continuar">Continuar</button>
                                                <button type="button"
        ...
        <!--  MODAL LINK-->
        <div class="modal fade bs-example-modal-lg" id="linkPopUp" tabindex="-1" role="dialog"
            aria-labelledby="myLargeModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                                ...
                                <div class="card-body">
                                    <form class="" id="formularioLink" action="#">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <p for="">Comparte este link a los colaboradores para que la
                                                    ejecuten. </p>
                                                <div class="input-group col-md-0">
                                                    <input class="form-control py-2 border-rigth-0 border "
                                                        readonly="readonly" type="text" value=""
                                                        placeholder="Link generado" id="link">
                                                    <span class="input-group-append">
                                                        <button onclick="CopiarClipBoard(this);"
                                                            class="btn border-rigth-0 border copiarLink" type="button">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" disabled
                                                        class="form-control input-number cantidadFrecuencia"
        ...
        <!--  MODAL VISUALIZACION-->
        <div class="modal fade bs-example-modal-lg" id="visualizacionPopUp" tabindex="-1" role="dialog"
            aria-labelledby="myLargeModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    ...
    @section('script')
        ...
        <script type="text/javascript" src="{{ assets_version('/vertical/assets/js/listachequeo/mislistas/main.js') }}">
        </script>
    @endsection
