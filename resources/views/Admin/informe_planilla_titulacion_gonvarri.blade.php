...
@section('css')
    <link rel="stylesheet"
        href="{{ assets_version('/vertical/assets/css/listachequeo/informe_planilla_titulacion/main.css') }}">
@endsection
...
@section('breadcrumb')
                                ...
                                <div class="row m-b-10">
                                    <div class="col-lg-12">
                                        <div class="contenedorBuscador contenedorBuscador--espacio">
                                            ...
                                            <form
                                                action="{{ url('/listachequeo/informe_planilla_titulacion/descargar-excel_gonvarri') }}"
                            ...
                            <div class="table-responsive">
                                <table id="tablaPlanillaTitulacion" class="table table-bordered m-b-0">
                                     <thead>
                                        ...
                                        <tr>
                                            <th colspan="{{ 2 + count($datosPlanilla['categorias']) + 16 }}"
                                                class="text-center text-white"
                                                style="vertical-align: middle; background-color: {{ $datosPlanilla['lista_chequeo']['color'] }}; font-weight: bold; font-size: 14px;">
                                        ...
                                        <tr>
                                            ...
                                            @foreach ($datosPlanilla['categorias'] as $categoria)
                                                <th colspan="{{ $categoria['colspan'] }}" class="text-center"
                                                    style="vertical-align: middle; background-color: {{ $categoria['color'] }}; font-weight: bold;">
                                                    {{ $categoria['nombre'] }}
                                                </th>
                                            @endforeach
                                            {{-- <th class="text-center"
                                                style="vertical-align: middle; background-color: #92D050; font-weight: bold;">
                                                Responsable</th>
                                            <th class="text-center"
                                                style="vertical-align: middle; background-color: #92D050; font-weight: bold;">
                                                Responsable</th> --}}
                                        ...
                                        <tr>
                                            @foreach ($datosPlanilla['categorias'] as $categoria)
                                                @foreach ($categoria['etiquetas'] as $etiqueta)
                                                    <th colspan="{{ $etiqueta['colspan'] }}" class="text-center"
                                                        style="vertical-align: middle; background-color: {{ $etiqueta['color'] }}; color: #fff; font-weight: bold; font-size: 11px;">
                                                        {{ $etiqueta['nombre'] }}
                                                    </th>
                                                @endforeach
                                            @endforeach
                                            {{-- <th rowspan="3" class="text-center"
                                                style="vertical-align: middle; font-weight: bold;">Firma Operario</th>
                                            <th rowspan="3" class="text-center"
                                                style="vertical-align: middle; background-color: #92D050; font-weight: bold;">
                                                Firma Líder U.V.A</th> --}}
                                        </tr>
                                        ...
                                        <tr>
                                            @foreach ($datosPlanilla['categorias'] as $categoria)
                                                @foreach ($categoria['etiquetas'] as $etiqueta)
                                                    <th colspan="{{ $etiqueta['colspan'] }}" class="text-center"
                                                        style="vertical-align: middle; background-color: {{ $etiqueta['color'] }}; color: #fff; font-weight: bold;">
                                        ...
                                        <tr>
                                            <th class="text-center"
                                                style="vertical-align: middle; background-color: #fc9425; font-weight: bold; font-size: 11px;">
                                                Fecha</th>
                                            <th class="text-center"
                                                style="vertical-align: middle; background-color: #fc9425; font-weight: bold; font-size: 11px;">
                                                Hora de titulación</th>
                                            @foreach ($datosPlanilla['categorias'] as $categoria)
                                                @foreach ($categoria['etiquetas'] as $etiqueta)
                                                    @foreach ($etiqueta['preguntas'] as $pregunta)
                                                        <th class="text-center"
                                                            style="vertical-align: middle; background-color: {{ $pregunta['color'] }}; font-weight: bold; font-size: 11px;">
                                                            {{ $pregunta['nombre'] }}
                                                        </th>
                                                    @endforeach
                                                @endforeach
                                        ...
                                        @if (count($datosPlanilla['registros']) > 0)
                                            @foreach ($datosPlanilla['registros'] as $registro)
                                                <tr>
                                                   ...
                                                   {{--  <td class="text-center" style="vertical-align: middle;">
                                                        {{ $registro['firma_operario'] }}</td>
                                                    <td class="text-center" style="vertical-align: middle;">
                                                        {{ $registro['firma_lider'] }}</td> --}}
                                                </tr>
                                            @endforeach
                                        @else
                                            <tr id="no-data-row">
                                                <td colspan="{{ 2 + count($datosPlanilla['categorias']) + 2 }}"
                                                    class="text-center" style="padding: 30px; vertical-align: middle;">
                                                    <p style="margin-top: 10px; font-size: 16px; color: #6c757d;">No hay
                                                        datos disponibles actualmente</p>
                                                </td>
                                            </tr>
                                        @endif
                                    </tbody>
    ...
    @endsection
@section('script')
    <script type="text/javascript" src="{{ assets_version('/vertical/assets/js/informe_planilla_titulacion_gonvarri/main.js') }}"></script>
@endsection