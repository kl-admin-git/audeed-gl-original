...
<table>
    <thead>
        ...
        <tr>
            <th colspan="{{ 2 + array_sum(array_column($data['categorias'], 'colspan')) }}" style="vertical-align: middle; background-color: {{ $data['lista_chequeo']['color'] }}; color: #ffffff; text-align: center; font-weight: bold; font-size: 12px; height: 30px; border: 1px solid #000000;">
